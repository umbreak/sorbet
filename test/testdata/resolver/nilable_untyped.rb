...
Bad = T.type_alias {T.nilable(T.untyped)} # error: `T.nilable(T.untyped)` is the same as `T.untyped`
...
class A
  ...
  X = type_member(upper: T.nilable(T.untyped)) # error: `T.nilable(T.untyped)` is the same as `T.untyped`

  sig {params(x: T.nilable(T.untyped)).void} # error: `T.nilable(T.untyped)` is the same as `T.untyped`
  def test1(x)
  end
...
class B < T::Struct
  ...
  prop :foo, T.nilable(T.untyped) # error: `T.nilable(T.untyped)` is the same as `T.untyped`

  const :bar, T.nilable(T.untyped), default: 10 # error: `T.nilable(T.untyped)` is the same as `T.untyped`
end
